...
$sort='ASC';
 ...
 {
  $sql ="SELECT * FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND ar >= '".mysql_real_escape_string($_REQUEST["from"])."' AND ar <= '".mysql_real_escape_string($_REQUEST["to"])."'".$search_rak.$search_garancia.$search_kat.$search_marka.$search_string.$orderby.$lap;
 } 
 else if ($_REQUEST["from"]<>'') 
 {
  $sql = "SELECT * FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND ar >= '".mysql_real_escape_string($_REQUEST["from"])."'".$search_rak.$search_garancia.$search_kat.$search_marka.$search_string.$orderby.$lap;
 } 
 else if ($_REQUEST["to"]<>'') 
 {
  $sql = "SELECT * FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND  ar <= '".mysql_real_escape_string($_REQUEST["to"])."'".$search_rak.$search_garancia.$search_kat.$search_marka.$search_string.$orderby.$lap;
 } 
 else if ($_REQUEST["marka"]<>'') 
 {
  $sql = "SELECT * FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND gyarto='".mysql_real_escape_string($_REQUEST["marka"])."'".$search_rak.$search_garancia.$search_kat.$search_marka.$search_string.$orderby.$lap;
 } 
 else if ($_REQUEST["garancia"]<>'') 
 {
  $sql = "SELECT * FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND garancia='".mysql_real_escape_string($_REQUEST["garancia"])."'".$search_rak.$search_garancia.$search_kat.$search_marka.$search_string.$orderby.$lap;
 } 
  else if ($_REQUEST["string"]<>'') 
 {
  $sql = "SELECT * FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND (cikkszam LIKE '%".mysql_real_escape_string($_REQUEST["string"])."%' OR cikknev LIKE '%".mysql_real_escape_string($_REQUEST["string"])."%')".$search_rak.$search_garancia.$search_kat.$search_marka.$search_string.$orderby.$lap;
 } 
 else if ($_REQUEST["marka"]<>'' and $_REQUEST["kat"]<>'') 
 {
  $sql = "SELECT * FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND gyarto='".mysql_real_escape_string($_REQUEST["marka"])."' AND (cikkcsopnev='".mysql_real_escape_string($_REQUEST["kat"])."' OR cikkfajta='".mysql_real_escape_string($_REQUEST["kat"])."')".$search_rak.$search_garancia.$search_kat.$search_marka.$search_string.$orderby.$lap;
 } 
 else if ($_REQUEST["marka"]<>'' and $_REQUEST["kat"]<>'' and $_REQUEST["garancia"]<>'') 
 {
  $sql = "SELECT * FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND gyarto='".mysql_real_escape_string($_REQUEST["marka"])."' AND (cikkcsopnev='".mysql_real_escape_string($_REQUEST["kat"])."' OR cikkfajta='".mysql_real_escape_string($_REQUEST["kat"])."' AND garancia='".mysql_real_escape_string($_REQUEST["garancia"])."')".$search_rak.$search_garancia.$search_kat.$search_marka.$search_string.$orderby.$lap;
 } 
 ...
 {
  $sql = "SELECT * FROM ".$SETTINGS["data_table"]." WHERE statusz=''".$search_rak.$search_garancia.$search_kat.$search_marka.$search_string.$orderby.$lap;
 }
//<!------------------------------------------------------------------------------------ SQL----------------------------------------------------------------------------------------------------->
...
//<!----------------------------------------------------------------------------------LAPOZÓS------------------------------------------------------------------------------------------------------------>
  if ($_REQUEST["from"]<>'' and $_REQUEST["to"]<>'')
 {
  $total_pages = "SELECT count(*)  FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND ar >= '".mysql_real_escape_string($_REQUEST["from"])."' AND ar <= '".mysql_real_escape_string($_REQUEST["to"])."'";
 } 
 
 if ($_REQUEST["from"]<>'' and $_REQUEST["to"]<>'' and $_REQUEST["kat"]<>'')
 {
  $total_pages = "SELECT count(*)  FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND ar >= '".mysql_real_escape_string($_REQUEST["from"])."' AND ar <= '".mysql_real_escape_string($_REQUEST["to"])."' AND (cikkcsopnev='".mysql_real_escape_string($_REQUEST["kat"])."' OR cikkfajta='".mysql_real_escape_string($_REQUEST["kat"])."')";
 }
  if ($_REQUEST["from"]<>'' and $_REQUEST["to"]<>'' and $_REQUEST["marka"]<>'' and $_REQUEST["garancia"]<>'')
 {
  $total_pages = "SELECT count(*)  FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND ar >= '".mysql_real_escape_string($_REQUEST["from"])."' AND ar <= '".mysql_real_escape_string($_REQUEST["to"])."' AND gyarto='".mysql_real_escape_string($_REQUEST["marka"])."' AND garancia='".mysql_real_escape_string($_REQUEST["garancia"])."'";
 }
  if ($_REQUEST["from"]<>'' and $_REQUEST["to"]<>'' and $_REQUEST["marka"]<>'' and $_REQUEST["kat"]<>'')
 {
  $total_pages = "SELECT count(*)  FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND ar >= '".mysql_real_escape_string($_REQUEST["from"])."' AND ar <= '".mysql_real_escape_string($_REQUEST["to"])."' AND gyarto='".mysql_real_escape_string($_REQUEST["marka"])."' AND (cikkcsopnev='".mysql_real_escape_string($_REQUEST["kat"])."' OR cikkfajta='".mysql_real_escape_string($_REQUEST["kat"])."')";
 } 
if ($_REQUEST["from"]<>'' and $_REQUEST["to"]<>'' and $_REQUEST["garancia"]<>'')
 {
  $total_pages = "SELECT count(*)  FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND ar >= '".mysql_real_escape_string($_REQUEST["from"])."' AND ar <= '".mysql_real_escape_string($_REQUEST["to"])."' AND garancia='".mysql_real_escape_string($_REQUEST["garancia"])."'";
 }
...
if ($_REQUEST["marka"]<>'' and $_REQUEST["kat"]<>'' and $_REQUEST["garancia"]<>'' and $_REQUEST["keszlet"]<>'' ) 
 {
 	$total_pages = "SELECT count(*) FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND gyarto='".mysql_real_escape_string($_REQUEST["marka"])."'AND (cikkcsopnev='".mysql_real_escape_string($_REQUEST["kat"])."' OR cikkfajta='".mysql_real_escape_string($_REQUEST["kat"])."') AND garancia='".mysql_real_escape_string($_REQUEST["garancia"])."' AND keszlet>='1'";
 }
 if ($_REQUEST["from"]<>'' and $_REQUEST["to"]<>'' and $_REQUEST["marka"]<>'')
 {
  $total_pages = "SELECT count(*)  FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND ar >= '".mysql_real_escape_string($_REQUEST["from"])."' AND ar <= '".mysql_real_escape_string($_REQUEST["to"])."' AND gyarto='".mysql_real_escape_string($_REQUEST["marka"])."'";
 }
else if ($_REQUEST["marka"]<>'' and $_REQUEST["kat"]<>'' and $_REQUEST["garancia"]<>'') 
 {
 	$total_pages = "SELECT count(*) FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND gyarto='".mysql_real_escape_string($_REQUEST["marka"])."'AND (cikkcsopnev='".mysql_real_escape_string($_REQUEST["kat"])."' OR cikkfajta='".mysql_real_escape_string($_REQUEST["kat"])."') AND garancia='".mysql_real_escape_string($_REQUEST["garancia"])."'";
 }
else if ($_REQUEST["marka"]<>'' and $_REQUEST["kat"]<>'') 
 {
 	$total_pages = "SELECT count(*) FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND gyarto='".mysql_real_escape_string($_REQUEST["marka"])."'AND (cikkcsopnev='".mysql_real_escape_string($_REQUEST["kat"])."' OR cikkfajta='".mysql_real_escape_string($_REQUEST["kat"])."')";
 }
else if ($_REQUEST["marka"]<>'' and $_REQUEST["garancia"]<>'') 
 {
 	$total_pages = "SELECT count(*) FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND gyarto='".mysql_real_escape_string($_REQUEST["marka"])."' AND garancia='".mysql_real_escape_string($_REQUEST["garancia"])."'";
 }
  else if ($_REQUEST["marka"]<>'' and $_REQUEST["keszlet"]<>'') 
 {
 	$total_pages = "SELECT count(*) FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND gyarto='".mysql_real_escape_string($_REQUEST["marka"])."' AND keszlet>='1'";
 }
 ...
 {
  $total_pages = "SELECT count(*)  FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND ar >= '".mysql_real_escape_string($_REQUEST["from"])."' AND ar <= '".mysql_real_escape_string($_REQUEST["to"])."' AND (cikkszam LIKE '%".mysql_real_escape_string($_REQUEST["string"])."%' OR cikknev LIKE '%".mysql_real_escape_string($_REQUEST["string"])."%')";
 }
 ...
 {
  $total_pages = "SELECT count(*)  FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND ar >= '".mysql_real_escape_string($_REQUEST["from"])."' AND ar <= '".mysql_real_escape_string($_REQUEST["to"])."' AND gyarto='".mysql_real_escape_string($_REQUEST["marka"])."' AND ar <= '".mysql_real_escape_string($_REQUEST["to"])."' AND keszlet>='1'";
 }
 else if ($_REQUEST["from"]<>'' and $_REQUEST["to"]<>'' and $_REQUEST["string"]<>'' and $_REQUEST["keszlet"]<>'')
 {
  $total_pages = "SELECT count(*)  FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND ar >= '".mysql_real_escape_string($_REQUEST["from"])."' AND ar <= '".mysql_real_escape_string($_REQUEST["to"])."' AND (cikkszam LIKE '%".mysql_real_escape_string($_REQUEST["string"])."%' OR cikknev LIKE '%".mysql_real_escape_string($_REQUEST["string"])."%') AND keszlet>='1'";
 }
 ...
 {
  $total_pages = "SELECT count(*)  FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND ar >= '".mysql_real_escape_string($_REQUEST["from"])."' AND ar <= '".mysql_real_escape_string($_REQUEST["to"])."' AND keszlet>='1'";
 }
else if ($_REQUEST["garancia"]<>'') 
 {
  $total_pages = "SELECT count(*) FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND garancia='".mysql_real_escape_string($_REQUEST["garancia"])."'";
 } 
 else if ($_REQUEST["marka"]<>'')  
 {
  $total_pages = "SELECT count(*) FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND gyarto='".mysql_real_escape_string($_REQUEST["marka"])."'";
 } 
 else if ($_REQUEST["kat"]<>'')  
 {
  $total_pages = "SELECT count(*) FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND (cikkcsopnev='".mysql_real_escape_string($_REQUEST["kat"])."' OR cikkfajta='".mysql_real_escape_string($_REQUEST["kat"])."')";
 }
 else if ($_REQUEST["to"]<>'')
 {
  $total_pages = "SELECT count(*)  FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND  ar <= '".mysql_real_escape_string($_REQUEST["to"])."'";
 } 
else if ($_REQUEST["string"]<>'')
 {
  $total_pages = "SELECT count(*)  FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND (cikkszam LIKE '%".mysql_real_escape_string($_REQUEST["string"])."%' OR cikknev LIKE '%".mysql_real_escape_string($_REQUEST["string"])."%')";
 } 
else if ($_REQUEST["keszlet"]<>'')
 {
  $total_pages = "SELECT count(*)  FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND keszlet>='1'";
 } 
 else
 {
  $total_pages = "SELECT count(*) FROM ".$SETTINGS["data_table"]." WHERE statusz='' ";
 }
...
<h9 class="text-center"><button class="btn btn-secondary"><a href="download.php">Adatbázis letöltése</a></button></h9>
<h9 class="text-center"><button class="btn btn-secondary"><a href="replace.php">Képek tagolása</a></button></h9>
<h9 class="text-center"><button class="btn btn-secondary"><a href="csv2sql.php">Adatbázis frissítése</a></button></h9>



<!------------------------------------------------------------------------------------------------ADATBÁZIS------------------------------------------------------------------------------> 
<h9><button class="btn btn-secondary"><a href="leiras.php">SÚGÓ</a></button></h9>
<input type="button" class='btn btn-success btn' value="Feltöltve" id="gomb" onclick="window.location.href='inventoryup.php'" />
<input type="button" class='btn btn-warning btn' value="Kihagyva" id="gomb" onclick="window.location.href='inventorydown.php'" />
<input type="button" class='btn btn-danger btn' value="Törölve" id="gomb" onclick="window.location.href='inventorydel.php'" />
<h5 class="text-center"><a href="inventory.php">Oldal újratöltés</a></h5>
<!---Felsőtábla\\\--->
<div>
...
<form action="" method="POST" class="form-group">
 ...
 <td>
  <input type='submit' class='btn btn-warning btn-lg' id="gomb" name="kihagy" value="Kihagy">
 </td>
 <td>
...
if ($_REQUEST["marka"]<>'' and $_REQUEST["kat"]<>'' and $_REQUEST["garancia"]<>'' and $_REQUEST["keszlet"]<>'' ) 
 ...
 else if ($_REQUEST["from"]<>'' and $_REQUEST["to"]<>'' and $_REQUEST["marka"]<>'')
 {
  $total_pages = "SELECT count(*)  FROM ".$SETTINGS["data_table"]." WHERE statusz='' AND ar >= '".mysql_real_escape_string($_REQUEST["from"])."' AND ar <= '".mysql_real_escape_string($_REQUEST["to"])."' AND gyarto='".mysql_real_escape_string($_REQUEST["marka"])."'";
 }
else if ($_REQUEST["marka"]<>'' and $_REQUEST["kat"]<>'' and $_REQUEST["garancia"]<>'') 
