...
<input type="button" class='btn btn-warning' value="Kihagyva" id="gomb" onclick="window.location.href='inventorydown.php'" />
...
<h5 class="text-center"><a href="inventoryup.php">Oldal újratöltés</a></h5>
...
<form action="" method="POST" class="form-group">
 <td>
  <input type='submit' class='btn btn-secondary btn-lg' id="gomb" name="feltolt" value="Feltölt">
 </td>
 <td>
